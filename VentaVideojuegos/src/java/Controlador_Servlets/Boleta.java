...
public class Boleta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       response.getWriter().println("sdsadasd");
       Reporte.pdf(31);
       /*try {
            Connection conn = MySQLconexion.getConexion();
            JasperReport reporte = null;
            String path = "D:\\trabajos de la u\\WEB-INT\\Proyecto-Desarrollo\\VentaVideojuegos\\src\\java\\Reportes\\VentaJuegos.jasper";
            Map parametro = new HashMap();
            parametro.put("id_usuario", 31);
